...
export default function SignUp() {
    ...
    useEffect(() => {
        ...
        Animated.sequence([
            Animated.spring(logoScale, {
                toValue: 1, friction: 4, tension: 60, useNativeDriver: false,
            }),
            Animated.sequence([
        ...
        Animated.parallel([
            ...
            Animated.timing(cardOpacity, {
                toValue: 1, duration: 600, delay: 300, useNativeDriver: false,
            }),
        ]).start();
    ...
    return (
        <View style={styles.container}>
            ...
            <FloatingEmoji emoji="🍗" delay={500} startX={width * 0.15} duration={9000} />
            <FloatingEmoji emoji="🥘" delay={2500} startX={width * 0.65} duration={10500} />
            <FloatingEmoji emoji="🍰" delay={4500} startX={width * 0.35} duration={8500} />
            <FloatingEmoji emoji="🥗" delay={1500} startX={width * 0.8} duration={11500} />
            <FloatingEmoji emoji="🍲" delay={3500} startX={width * 0.5} duration={7000} />
            <FloatingEmoji emoji="☕" delay={500} startX={width * 0.05} duration={10000} />

            <View style={styles.decorCircle1} />
            <View style={styles.decorCircle2} />

            <Animated.View style={[styles.backContainer, { opacity: backBtnOpacity }]}>
                <TouchableOpacity
            ...
            <View style={styles.content}>
                ...
                >
                    ...
                    <Animated.Text style={[styles.subtitle, { opacity: subtitleOpacity }]}>
                        Join Yummyfi & discover amazing food
                    </Animated.Text>
